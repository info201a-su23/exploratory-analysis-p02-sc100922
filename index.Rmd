...
Our group's choice to use a lineplot was made in order to accurately portray the trend of total cases over the past ten years, from January 2013 to May 2022.  This particular type of graph enables us to identify any significant trends or anomalies in the data.  After plotting out the graph, our group found that the data have a few outliers.   For example, we found that the data from 2013 and 2022 are not complete.   Unluckily, we can not estimate the total cases of in 2013 because its data was not continuously recorded.   But we can estimate the shooting case of 2022 because it is reliable and can be estimated on continuous historical data.

Moreover, we believe that the number of shooting cases increased from 2014 to 2016.    However, since the government is imposing strict policies on gun control, we do see some gun shooting cases decrease from 2017 to 2019.    However, because of covid, the shooting cases increased quickly once the pandemic started. This is reasonable because there was high unemployment during the Covid, meaning that society was not safe as before. However, as the pandemic ended and the government's policy on encouraging firms to develop and provide jobs for people, we do see the number of shooting cases declines in recent 2 years.
...
When we find a significant public safety threat in gun violence data analysis, it means that guns pose a real and direct danger to the public. For states with the highest number of casualties, it is crucial to take emergency intervention measures to reduce the impact on society and the economy.
